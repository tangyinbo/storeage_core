			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<form
							action="${pageContext.request.contextPath }/system/user/create"
							method="post" class="form-horizontal" />
						<div class="control-group">
							<label class="control-label">用户名:</label>
							<div class="controls">
								<input type="text" class="input-xxlarge" name="userName" /> <span
									class="help-block">长度不少于6位</span>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">真实姓名:</label>
							<div class="controls">
								<input type="text" name="realName" class="input-xxlarge"
						...
						<div class="control-group">
							...
							<div class="controls">
								<dict:radio radioName="sex" dictTypeId="sex" reViewDictId="male"></dict:radio>
							</div>
						</div>
						<div class="control-group">
